...
export async function getServerSideProps({ params }) {
  ...
  const AuthorizationToken = ``
  let config = {
    headers: {
      Authorization: `Bearer ${AuthorizationToken}`,
    },
  };
  const res = await axios("http://ec2-3-109-2-132.ap-south-1.compute.amazonaws.com:1337/api/blogs?populate=*", config);
